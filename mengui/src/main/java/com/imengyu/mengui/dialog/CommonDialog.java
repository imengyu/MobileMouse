...
import com.imengyu.mengui.dialog.fragment.CommonDialogFragment;
...
public class CommonDialog {
    ...
    public CommonDialog setEditTextErrorText(int textId) {
        commonDialogInternal.editTextErrorText = activity.getString(textId);
        if(commonDialogInternal.isShowing())
            commonDialogInternal.refreshEditErr();
        return this;
    }
    public CommonDialog setEditTextErrorText(String message) {
        commonDialogInternal.editTextErrorText = message;
        if(commonDialogInternal.isShowing())
            commonDialogInternal.refreshEditErr();
        return this;
    }
    public CommonDialog setEditInputType(int inputType) {
        commonDialogInternal.editTextInputType = inputType;
        if(commonDialogInternal.isShowing())
            commonDialogInternal.refreshEdit();
        return this;
    }
    ...
    public CommonDialog setCustomView(View view) {
        commonDialogInternal.customView = view;
        if(commonDialogInternal.isShowing())
            commonDialogInternal.refreshCustomView();
        return this;
    }
    ...
    public View getCustomView(View view) {
        return commonDialogInternal.customView;
    }
